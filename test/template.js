    ...
    describe('link context', () => {
        ...
        it('should remplace source link by link body in the context', () => {
            ...
            for (const { context, target, type } of linksMarked) {
                if (type !== 'undefined') {
                    context.should.to.include(`*&#91;&#91;${type}:${target.id}&#93;&#93;*{.id-context data-target-id=${target.id}}`);
                } else {
                    context.should.to.include(`*&#91;&#91;${target.id}&#93;&#93;*{.id-context data-target-id=${target.id}}`);
                }
            }
        });
        ...
        it('should remplace source backlink by link body in the context', () => {
            ...
            for (const { context, type } of linksMarked) {
                if (type !== 'undefined') {
                    context.should.to.include(`*&#91;&#91;${type}:${id}&#93;&#93;*{.id-context data-target-id=${id}}`);
                } else {
                    context.should.to.include(`*&#91;&#91;${id}&#93;&#93;*{.id-context data-target-id=${id}}`);
                }
            }
        });
    });
