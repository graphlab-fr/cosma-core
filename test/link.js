...
describe('Link', () => {
    describe('wikilinks from content', () => {
        ...
        const content =
`Lorem ipsum dolor sit amet [[${ids[0]}]], consectetur adipiscing elit. Sed eleifend arcu sit amet condimentum malesuada [[${typePrefix}:${ids[1]}|${textSuffix}]].
...
Ut dapibus consectetur libero, quis tempor ligula [[${ids[4]}]] bibendum vitae. Quisque lectus lorem, vulputate [[${ids[0]}]] a molestie vitae, scelerisque eget lacus.`;
        ...
        describe('parsing with regex', () => {
            it('should parse paragraphs', () => {
                ...
                paragraphs[0].endsWith(`malesuada [[${typePrefix}:${ids[1]}|${textSuffix}]].`).should.be.true;
                ...
                paragraphs[2].endsWith(`[[${ids[0]}]] a molestie vitae, scelerisque eget lacus.`).should.be.true;
            });
