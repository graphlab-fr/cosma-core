...
describe('Report', () => {
    ...
    it('should report about record type change', () => {
        ...
        new Record(1, 'Record 1', 'undefined', undefined, undefined, undefined, links, undefined, undefined, undefined, undefined, undefined, opts);
    ...
    it('should report about record type change', () => {
        ...
        new Record(1, 'Record 1', 'foo', undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, opts);
        new Record(2, 'Record 2', 'bar', undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, opts);
        Report.listWarnings.size.should.be.equal(1);
    ...
    it('should report about ignored record meta', () => {
        ...
        new Record(1, 'Record 1', 'undefined', undefined, { 'foo': 'toto', 'bar': 'toto' }, undefined, undefined, undefined, undefined, undefined, undefined, undefined, opts);
        Report.listWarnings.size.should.be.equal(1);
        Report.listWarnings.has(1).should.be.true;
        const report = Report.listWarnings.get(1);
        report.should.have.length(1);
    ...
    it('should report about null record meta', () => {
        const opts = { record_metas: ['foo'] }
        new Record(1, 'Record 1', 'undefined', undefined, { 'foo': null }, undefined, undefined, undefined, undefined, undefined, undefined, undefined, opts);
        Report.listWarnings.size.should.be.equal(1);
        Report.listWarnings.has(1).should.be.true;
        const report = Report.listWarnings.get(1);
        report.should.have.length(1);
    ...
    it('should report about invalid record time', () => {
        new Record(1, 'Record 1', 'undefined', undefined, undefined, undefined, undefined, undefined, '2001/2/8', '2022-10-02');
        new Record(2, 'Record 2', 'undefined', undefined, undefined, undefined, undefined, undefined, 'foo', '1999');
        new Record(3, 'Record 2', 'undefined', undefined, undefined, undefined, undefined, undefined, undefined, '2022-10-02');
        Report.listErrors.size.should.be.equal(1);
    ...
    it('should report about unknown bibliographic reference', () => {
        ...
        new Record(1, 'Record 1', 'undefined', undefined, undefined, text, undefined, undefined, undefined, undefined, bibliographicRecords)
